...
static const WeaponDef& ifvWeapon(UnitType cargo) {
    ...
    static const WeaponDef wNoneW{0, 0, 999, false, false, "shell", 1, 1, 1};          // 工程师/间谍：无武器
    static const WeaponDef wPsi{0, 7, 40, false, true, "psychic", 1.0f, 0.0f, 0.0f};  // 尤里：心灵（伤害由心控逻辑处理）
    switch (cargo) {
        ...
        case UnitType::Chrono: case UnitType::ChronoCommando: return wChr;
        case UnitType::Engineer: case UnitType::Spy: return wNoneW;
        case UnitType::Yuri: case UnitType::PsiCommando: case UnitType::Initiate: return wPsi;
        default: return wGun;
    }
}
